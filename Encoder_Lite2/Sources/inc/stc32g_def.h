#ifndef __STC32G_DEF_H__
#define __STC32G_DEF_H__
...
#define HSPWMA_C2SwitchP5413()          PWMA_C2SwitchP5413()
...
#define LIN_SwitchP0203()               MODIFY_REG(P_SW1, LIN_PS_MSK, ((0) << 0))
#define LIN_SwitchP5253()               MODIFY_REG(P_SW1, LIN_PS_MSK, ((1) << 0))
#define LIN_SwitchP4647()               MODIFY_REG(P_SW1, LIN_PS_MSK, ((2) << 0))
#define LIN_SwitchP7273()               MODIFY_REG(P_SW1, LIN_PS_MSK, ((3) << 0))

#define CAN1_PS_MSK                     (BIT5 | BIT4)
#define CAN1_SwitchP0001()              MODIFY_REG(P_SW1, CAN1_PS_MSK, ((0) << 4))
#define CAN1_SwitchP5051()              MODIFY_REG(P_SW1, CAN1_PS_MSK, ((1) << 4))
#define CAN1_SwitchP4245()              MODIFY_REG(P_SW1, CAN1_PS_MSK, ((2) << 4))
#define CAN1_SwitchP7071()              MODIFY_REG(P_SW1, CAN1_PS_MSK, ((3) << 4))

#define CAN2_PS_MSK                     (BIT1 | BIT0)
#define CAN2_SwitchP0203()              MODIFY_REG(P_SW3, CAN2_PS_MSK, ((0) << 0))
#define CAN2_SwitchP5253()              MODIFY_REG(P_SW3, CAN2_PS_MSK, ((1) << 0))
#define CAN2_SwitchP4647()              MODIFY_REG(P_SW3, CAN2_PS_MSK, ((2) << 0))
#define CAN2_SwitchP7273()              MODIFY_REG(P_SW3, CAN2_PS_MSK, ((3) << 0))
...
#define AUXR2_LINEN_MSK                 BIT0
#define LIN_Enable()                    SET_REG_BIT(AUXR2, AUXR2_LINEN_MSK)
#define LIN_Disable()                   CLR_REG_BIT(AUXR2, AUXR2_LINEN_MSK)

#define LINICR_LINIE_MSK                BIT1
#define LIN_EnableInt()                 SET_REG_BIT(LINICR, LINICR_LINIE_MSK)
#define LIN_DisableInt()                CLR_REG_BIT(LINICR, LINICR_LINIE_MSK)

#define LINICR_PLINL_MSK                BIT0
#define LINICR_PLINH_MSK                BIT3
#define LIN_SetIntPriority(n)           MODIFY_REG(LINICR, LINICR_PLINL_MSK, (((n) & 1) << 0)); \
                                        MODIFY_REG(LINICR, LINICR_PLINH_MSK, ((((n) >> 1) & 1) << 3))
...
#ifndef READ_CAN
#define READ_CAN(r)                     (CANAR = (r), READ_REG(CANDR))
#endif
#ifndef WRITE_CAN
#define WRITE_CAN(r, dat)               (CANAR = (r), WRITE_REG(CANDR, (dat)))
#endif
#ifndef MODIFY_CAN
#define MODIFY_CAN(r, clr, set)         (CANAR = (r), MODIFY_REG(CANDR, (clr), (set)))
#endif
#ifndef CLR_CAN_BIT
#define CLR_CAN_BIT(r, b)               (CANAR = (r), CLR_REG_BIT(CANDR, (b)))
#endif
#ifndef SET_CAN_BIT
#define SET_CAN_BIT(r, b)               (CANAR = (r), SET_REG_BIT(CANDR, (b)))
#endif
#ifndef READ_CAN_BIT
#define READ_CAN_BIT(r, b)              (CANAR = (r), READ_REG_BIT(CANDR, (b)))
#endif
...
#define AUXR2_CANSEL_MSK                BIT3
#define CAN1_SEL()                      CLR_REG_BIT(AUXR2, AUXR2_CANSEL_MSK)
#define CAN2_SEL()                      SET_REG_BIT(AUXR2, AUXR2_CANSEL_MSK)
#define CAN1_ACTIVE()					(READ_REG_BIT(AUXR2, AUXR2_CANSEL_MSK) == 0)
#define CAN2_ACTIVE()					(READ_REG_BIT(AUXR2, AUXR2_CANSEL_MSK) != 0)
...
#define CAN2_SetIntPriority(n)          MODIFY_REG(CANICR, CANICR_PCAN2L_MSK, (((n) & 1) << 0)); \
                                        MODIFY_REG(CANICR, CANICR_PCAN2H_MSK, ((((n) >> 1) & 1) << 3))

#define MR_RM_MSK                       BIT2
#define CAN_EnterResetMode()            SET_CAN_BIT(MR, MR_RM_MSK)
#define CAN_ExitResetMode()             CLR_CAN_BIT(MR, MR_RM_MSK)

#define MR_LOM_MSK                      BIT1
#define CAN_ListenOnlyMode()			SET_CAN_BIT(MR, MR_LOM_MSK)
#define CAN_NormalMode()				CLR_CAN_BIT(MR, MR_LOM_MSK)

#define MR_AFM_MSK                      BIT0
#define CAN_SingleFilter()              SET_CAN_BIT(MR, MR_AFM_MSK)
#define CAN_DoubleFilter()              CLR_CAN_BIT(MR, MR_AFM_MSK)

#define CMR_TR_MSK                      BIT2
#define CMR_AT_MSK                      BIT1
#define CAN_TriggerTransmit()           WRITE_CAN(CMR, CMR_TR_MSK)
#define CAN_AbortTransmit()             WRITE_CAN(CMR, CMR_AT_MSK)

#define SR_RBS_MSK                      BIT7
#define SR_DSO_MSK                      BIT6
#define SR_TBS_MSK                      BIT5
#define SR_RS_MSK                       BIT3
#define SR_TS_MSK                       BIT2
#define SR_ES_MSK                       BIT1
#define SR_BS_MSK                       BIT0
#define CAN_CheckRBufferStatus()        READ_CAN_BIT(SR, SR_RBS_MSK)
#define CAN_CheckOverrunStatus()        READ_CAN_BIT(SR, SR_DSO_MSK)
#define CAN_CheckTBufferStatus()        READ_CAN_BIT(SR, SR_TBS_MSK)
#define CAN_CheckReceiveStatus()        READ_CAN_BIT(SR, SR_RS_MSK)
#define CAN_CheckTransmitStatus()       READ_CAN_BIT(SR, SR_TS_MSK)
#define CAN_CheckErrorStatus()          READ_CAN_BIT(SR, SR_ES_MSK)
#define CAN_CheckBusOffStatus()         READ_CAN_BIT(SR, SR_BS_MSK)

#define ISR_ALI_MSK                     BIT6
#define ISR_EWI_MSK                     BIT5
#define ISR_EPI_MSK                     BIT4
#define ISR_RI_MSK                      BIT3
#define ISR_TI_MSK                      BIT2
#define ISR_EBI_MSK                     BIT1
#define ISR_DOI_MSK                     BIT0
#define CAN_CheckArbitrateLost(f)       READ_REG_BIT((f), ISR_ALI_MSK)
#define CAN_CheckErrorWarning(f)        READ_REG_BIT((f), ISR_EWI_MSK)
#define CAN_CheckErrorPassive(f)        READ_REG_BIT((f), ISR_EPI_MSK)
#define CAN_CheckReceive(f)             READ_REG_BIT((f), ISR_RI_MSK)
#define CAN_CheckTransmit(f)            READ_REG_BIT((f), ISR_TI_MSK)
#define CAN_CheckBusError(f)            READ_REG_BIT((f), ISR_EBI_MSK)
#define CAN_CheckDataOverrun(f)         READ_REG_BIT((f), ISR_DOI_MSK)

#define CAN_ReadIntStatus()             READ_CAN(ISR)
#define CAN_ClearFlags(f)               WRITE_CAN(ISR, (f))

#define IMR_ALIM_MSK                    BIT6
#define IMR_EWIM_MSK                    BIT5
#define IMR_EPIM_MSK                    BIT4
#define IMR_RIM_MSK                     BIT3
#define IMR_TIM_MSK                     BIT2
#define IMR_EBIM_MSK                    BIT1
#define IMR_DOIM_MSK                    BIT0
#define CAN_EnableArbitrateLostInt()    SET_CAN_BIT(IMR, IMR_ALIM_MSK)
#define CAN_EnableErrorWarningInt()     SET_CAN_BIT(IMR, IMR_EWIM_MSK)
#define CAN_EnableErrorPassiveInt()     SET_CAN_BIT(IMR, IMR_EPIM_MSK)
#define CAN_EnableReceiveInt()          SET_CAN_BIT(IMR, IMR_RIM_MSK)
#define CAN_EnableTransmitInt()         SET_CAN_BIT(IMR, IMR_TIM_MSK)
#define CAN_EnableBusErrorInt()         SET_CAN_BIT(IMR, IMR_EBIM_MSK)
#define CAN_EnableDataOverrunInt()      SET_CAN_BIT(IMR, IMR_DOIM_MSK)
#define CAN_DisableArbitrateLostInt()   CLR_CAN_BIT(IMR, IMR_ALIM_MSK)
#define CAN_DisableErrorWarningInt()    CLR_CAN_BIT(IMR, IMR_EWIM_MSK)
#define CAN_DisableErrorPassiveInt()    CLR_CAN_BIT(IMR, IMR_EPIM_MSK)
#define CAN_DisableReceiveInt()         CLR_CAN_BIT(IMR, IMR_RIM_MSK)
#define CAN_DisableTransmitInt()        CLR_CAN_BIT(IMR, IMR_TIM_MSK)
#define CAN_DisableBusErrorInt()        CLR_CAN_BIT(IMR, IMR_EBIM_MSK)
#define CAN_DisableDataOverrunInt()     CLR_CAN_BIT(IMR, IMR_DOIM_MSK)

#define BTR0_SJW_MSK                    (BIT7 | BIT6)
#define CAN_SetSJW(n)                   MODIFY_CAN(BTR0, BTR0_SJW_MSK, ((n) << 6))

#define BTR0_BRP_MSK                    (BIT5 | BIT4 | BIT_LN)
#define CAN_SetBRP(n)                   MODIFY_CAN(BTR0, BTR0_BRP_MSK, ((n) << 0))

#define BTR1_SAM_MSK                    BIT7
#define CAN_SampleOnce()                CLR_CAN_BIT(BTR1, BTR1_SAM_MSK)
#define CAN_Sample3Times()              SET_CAN_BIT(BTR1, BTR1_SAM_MSK)

#define BTR1_TSG2_MSK                   (BIT6 | BIT5 | BIT4)
#define CAN_SetTSG2(n)                  MODIFY_CAN(BTR1, BTR1_TSG2_MSK, ((n) << 4))

#define BTR1_TSG1_MSK                   (BIT_LN)
#define CAN_SetTSG1(n)                  MODIFY_CAN(BTR1, BTR1_TSG1_MSK, ((n) << 0))

#define CAN_WriteBUF0(d)                WRITE_CAN(TX_BUF0, (d))
#define CAN_WriteBUF1(d)                WRITE_CAN(TX_BUF1, (d))
#define CAN_WriteBUF2(d)                WRITE_CAN(TX_BUF2, (d))
#define CAN_WriteBUF3(d)                WRITE_CAN(TX_BUF3, (d))

#define CAN_WriteBUF(n, d)              WRITE_CAN(TX_BUF0 + ((n) & 0x03), (d))

#define CAN_ReadBUF0()                  READ_CAN(RX_BUF0)
#define CAN_ReadBUF1()                  READ_CAN(RX_BUF1)
#define CAN_ReadBUF2()                  READ_CAN(RX_BUF2)
#define CAN_ReadBUF3()                  READ_CAN(RX_BUF3)

#define CAN_ReadBUF(n)                  READ_CAN(RX_BUF0 + ((n) & 0x03))

#define CAN_SetACR0(d)                  WRITE_CAN(ACR0, (d))
#define CAN_SetACR1(d)                  WRITE_CAN(ACR1, (d))
#define CAN_SetACR2(d)                  WRITE_CAN(ACR2, (d))
#define CAN_SetACR3(d)                  WRITE_CAN(ACR3, (d))

#define CAN_SetAMR0(d)                  WRITE_CAN(AMR0, (d))
#define CAN_SetAMR1(d)                  WRITE_CAN(AMR1, (d))
#define CAN_SetAMR2(d)                  WRITE_CAN(AMR2, (d))
#define CAN_SetAMR3(d)                  WRITE_CAN(AMR3, (d))

#define ECC_RXWRN_MSK                   BIT7
#define ECC_TXWRN_MSK                   BIT6
#define ECC_EDIR_MSK                    BIT5
#define ECC_ACKER_MSK                   BIT4
#define ECC_FRMER_MSK                   BIT3
#define ECC_CRCER_MSK                   BIT2
#define ECC_STFER_MSK                   BIT1
#define ECC_BER_MSK                     BIT0
#define CAN_CheckRxWarning()            READ_CAN_BIT(ECC, ECC_RXWRN_MSK)
#define CAN_CheckTxWarning()            READ_CAN_BIT(ECC, ECC_TXWRN_MSK)
#define CAN_CheckDirError()             READ_CAN_BIT(ECC, ECC_EDIR_MSK)
#define CAN_CheckACKError()             READ_CAN_BIT(ECC, ECC_ACKER_MSK)
#define CAN_CheckFrameError()           READ_CAN_BIT(ECC, ECC_FRMER_MSK)
#define CAN_CheckCRCError()             READ_CAN_BIT(ECC, ECC_CRCER_MSK)
#define CAN_CheckStuffError()           READ_CAN_BIT(ECC, ECC_STFER_MSK)
#define CAN_CheckBitError()             READ_CAN_BIT(ECC, ECC_BER_MSK)

#define CAN_GetRecvMsgCount()           READ_CAN(RMC)
#define CAN_GetRxErrCount()             READ_CAN(RXERR)
#define CAN_GetTxErrCount()             READ_CAN(TXERR)
#define CAN_GetArbitrateLostCode()      READ_CAN(ALC)

#define CAN_EXTENDED_MSK                BIT7
#define CAN_REMOTE_MSK                  BIT6
#define CANFMT_STDDAT                   (0)
#define CANFMT_STDRMT                   (CAN_REMOTE_MSK)
#define CANFMT_EXTDAT                   (CAN_EXTENDED_MSK)
#define CANFMT_EXTRMT                   (CAN_EXTENDED_MSK | CAN_REMOTE_MSK)

#define CAN_DLC_MSK                     (BIT_LN)
#define CAN_DATALEN(n)                  (((n) << 0) & CAN_DLC_MSK)

#define CANID_STD(n)                    ((n) << 5)
#define CANID_EXT(n)                    ((n) << 3)
...
#define HSPWMA_SetRepeatCounter(n)      (WRITE_HSPWMA(PWMA_RCR, LOBYTE(n)))
...
#define HSPWMB_SetRepeatCounter(n)      (WRITE_HSPWMB(PWMB_RCR, LOBYTE(n)))
